      ...
      <div className="w-[82%] h-auto mt-5 ">
        ...
        <div className="">
          ...
          <ul className="flex ">
            ...
            <li className="ml-[670px] pt-2 pb-1 px-4 mt-7 text-sm text-white w-25 h-8 bg-red-500">
              View All
            </li>
          </ul>
        </div>
        ...
        <div className="mt-10 flex justify-between">
          {cart.map((val: items4, id: number) => (
            <div
              className="ml-3 w-60 bg-white rounded-lg shadow-lg overflow-hidden"
              key={id}
            >
              {/* Image Section */}
        ...
        <div className="w-full bg-black h-auto mt-[90px] flex justify-between">
          <div className="w-[40%] pl-10 transform translate-x-5 pt-10 ">
            ...
            <h1 className="text-4xl text-white font-extrabold mt-6">
            ...
            <div>
              <div className="w-25 mt-10 h-7 py-1 pl-3 pr-3 text-white text-sm bg-green-400 absolute">
                Buy Now
              </div>
            </div>
          </div>
