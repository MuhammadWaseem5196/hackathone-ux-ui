...
<div><h1 className=" text-2xl pl-3 font-bold mt-6">Flash Sales</h1></div>
   
   <div className="flex">
   <li className=" mt-7 text-2xl text-gray-300"><FaArrowCircleLeft /></li>
...
<div className=" ml-3 w-50 bg-white rounded-lg shadow-lg mt-6 " key={id}>
      {/* Image Section */}
...
<div className=" w-25  h-7 bg-red-600 text-white text-sm  flex justify-normal items-center p-4">view All Prodcuts</div>
</div>
